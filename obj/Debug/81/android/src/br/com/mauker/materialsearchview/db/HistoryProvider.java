...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BR.Com.Mauker.MaterialSearchViewLib.Db.HistoryProvider, MaterialSearchView", HistoryProvider.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == HistoryProvider.class)
			mono.android.TypeManager.Activate ("BR.Com.Mauker.MaterialSearchViewLib.Db.HistoryProvider, MaterialSearchView", "", this, new java.lang.Object[] {  });
	}
